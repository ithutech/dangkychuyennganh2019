...
var script_url = "https://script.google.com/macros/s/AKfycbz9JbswKihC1-Oqhdk_tMFLrrt02W56L7U44yf3FqNYTrPvrA8/exec"
...
$("#submitIOT").click(function(event) {
	...
	var sdt = $("#sdt").val();
    var url = script_url + "?callback=result&masv=" + masv + "&lop=" + lop + "&email=" + email +  "&hovaten=" + hovaten + "&chuyennganh=" +chuyennganh + "&date=" +date +"&gioitinh"+gioitinh+"&dtb"+dtb+ "&sdt=" + sdt + "&action=register";
	console.log(url);
